...
csvName = 'test2_12_7.csv' #create a filename for the output CSV
clippedName = 'test2_12_7.mp4' #create a base filename for the four edited videos (camera identifiers will be appended onto this base filename)
